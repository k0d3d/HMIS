...
$getwaitinglist = mysql_query("select * from labwaiting order by id ASC") or die(mysql_error());
...
echo "<h1><font color = \"green\">$msg</font></h1>";}
      ...
      <div class="row-fluid">
        <div class="box ">
          <div class="title">
            <h4> <span>Laboratory waiting list.</span> </h4>
          </div>
          <!-- End .title -->
            ...
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              <thead>
                <tr>
                  ...
                  <th class="to_hide_phone  no_sort">Patient's name</th>
                  <th class="to_hide_phone no_sort">Doctor's name</th>
                  <th class="">Timer</th>
...
$duser = mysql_query("SELECT * FROM `user` WHERE `id`='".$did1."'");
$user_row=mysql_fetch_array($duser);
$doctorname = $user_row['staffname'];
?>
              
                <tr>
                 
                  <td><img class="thumbnail small" src="img/message_avatar4.png"></td>
                  <td class="to_hide_phone"><a href = "labform.php?id=<?php echo "$relative"; ?>&activate&timer=<?php echo "$time1"; ?>"><?php echo "$username"; ?> <?php echo "$othername"; ?></a></td>
                  <td class="to_hide_phone"><div class="row-fluid"><small>
                      <div class="span12"><strong><?php echo "$doctorname"; ?></strong></div>
                      </small></div>
                    </td>
...
{
location.reload();
}, 40000); // refresh every 10000 milliseconds
</script>
              </tbody>
            </table>
          </div>
