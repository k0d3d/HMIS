      ...
      <div class="row-fluid">
        <div class="span3">
          ...
          <!-- End .title -->
            ...
            <ul class="nav nav-tabs dark nav-stacked">
              <li><a href="#"><i class="icon-ok"></i> Rx</a></li>
              <li><a href="#"><i class="gicon-wrench"></i> Investigations</a></li>
        ...
        <div class="span9">
           ...
           <div class="box paint color_11">
              ...
              <form class="form-horizontal" action="#">
                ...
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <textarea rows="6" cols = "6" class="row-fluid autogrow" id="elastic-textarea" placeholder="Start typing"></textarea>
                  </div>
                </div>
		    ...
		    <div class="row-fluid well well-small"> <img class="row-fluid" src="img/mani.jpg"> </div>
        </div>
        <!-- End .span6 -->
         <div class="span6">
