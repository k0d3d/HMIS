...
$csfchloride = isset($_POST["csfchloride"]);
...
$sensitivity = isset($_POST["sensitivity"]);
$glucoserandom = isset($_POST["glucoserandom"]);
$mp = isset($_POST["mp"]);
$widal = isset($_POST["widal"]);
...
$sql_insert = "INSERT into `labrequest`
		...
		`csf chloride`,`Serum globulin`,`ALbumin/globulin ratio`,`2hr pp`,`Oral g.t.t`,`Fasting level`,`30minutes`,`60minutes`,`90minutes`,`120minutes`,`Gluc top. test. (g.t.t)`,`Gyclosylated hb`,
		...
		`Hvs Culture yielded`,`Urine colour`,`sensitivity`,`Appearance`,`Microscopy`,`Puscells/hpt`,`Mcs Epith cells`,`Casts`,`Crystals`,`Rbc`,`Mcs Bacteria`,`Yeasts cell`,`Trichomonas vaginalis`,`Mcs Culture yielded`,`Throat swab`,`Ear swab`,`Pus swab`,`Wound swab`,`Urethral swab`,`Urinalysis`,`date`,`doctorid`,`glucoserandom`,`mp`,`widal`)
        VALUES
        ('$patientid','$diagnosis','$specimen','$labno','$haemoglobin','$heamatocritpcv','$wbccount','$polymneutrophils','$lymphocytes','$eosinophils','$basophils','$monocytes','$directcoombs','$indirectcoombs','$heafmantouxtest','$hiv12screening','$vdrl','$pregnancytest','$rheumatoidfactor',
		...
		'$hpyloriquantative','$totalbilirubin','$directbilirubin','$sgot','$sgpt','$alkphosphatase','$totalprotein','$acidphos','$amylase','$calcium','$phosphorus','$sodiumna','$potassiumk','$chloridecl','$bicarbonate','$csfglucose','$csfprotein','$csfchloride','$serumglobulin',
		...
		'$urinecolourmcs','$sensitivity','$urinalappearance','$microscopy','$puscellshpt','$mcsepithcells','$casts','$crystals','$rbc','$mcsbacteria','$yeastscell','$trichomonasvaginalis','$mcscultureyielded','$throatswab','$earswab','$pusswab','$woundswab','$Urethralswab','$urinalysis','".date("U")."','$_SESSION[staff_id]','$glucoserandom','$mp','$widal')
      ";

mysql_query($sql_insert) or die("Insertion Failed:" . mysql_error()); 
$relative_id = mysql_insert_id();  

mysql_query("INSERT INTO `labwaiting`
(`patientid`,`doctorid`,`timer`,`relative`)
VALUES
('$patientid','$_SESSION[staff_id]','".date("U")."','$relative_id')
");
...
VALUES
('$_SESSION[staff_id]','Requested a laboratory test for $patientsurname $patientother','".date("U")."','$_GET[patient]')
");
...
<fieldset>
                        <div class="control-group row-fluid"> 
                          ...
                          <div class="controls span9">
                           <input value = "" type="text" id="diagnosis" name="diagnosis" placeholder="" class="row-fluid">
                          ...
                          <div class="controls span9">
                           <input value = "" type="text" id="specimen" name="specimen" placeholder="" class="row-fluid">
                          ...
                          <div class="controls span9">
                           <input value = "" type="text" id="labno" name="labno" placeholder="" class="row-fluid">
            ...
            <div class="content cursor ">
              <form class="form-horizontal" action="#">
                ...
                <div class="form-row control-group row-fluid ">
                  ...
                  <label class="control-label span3">Select tests to perform </label>
                  <div class="controls span9">
                <label class="checkbox inline">
                      <input type="checkbox" id="heamatocritpcv" name="heamatocritpcv" value="heamatocrit pcv">
                    ...
                    <label class="checkbox inline">
					  ...
					  <label class="checkbox inline">
                      <input type="checkbox" name = "bloodgroup" id="bloodgroup" value="blood group">
                      Blood group</label>
					  <br />
			 <label class="checkbox inline">
                     ...
                     Glucose fasting</label><br />
					 <label class="checkbox inline">
                      <input type="checkbox" id="glucoserandom" name="glucoserandom" value="glucose random">
                     Glucose random</label>
					 <label class="checkbox inline">
                      <input type="checkbox" id="mp" name="mp" value="mp">
                     Mp</label>
					 <label class="checkbox inline">
                      <input type="checkbox" id="widal" name="widal" value="widal">
                     Widal</label>
					 <label class="checkbox inline">
...
<div class="form-row control-group row-fluid ">
				  ...
				  <label class="checkbox ">
                      <input type="checkbox" checked id="liverfunction" name="liverfunction" value="liver function">
                    Perform liver function test</label>
                  ...
                  <div class="controls span100">
                    ...
                    <label class="checkbox">
                     ...
                     Chloride(cl)</label>
                      ...
                      Csf protein</label>
					  <label class="checkbox">
                      <input type="checkbox" id="csfchloride" name="csfchloride" value="csf protein">
                      Csf chloride</label>
                       <label class="checkbox">
		   ...
		   <div class="box paint color_3">
            ...
            <div class="content">
              <ul id="tabExample1" class="nav nav-tabs">
                ...
                <li><a href="#mcs" data-toggle="tab">Urine Mcs</a></li>
...
<fieldset>
				...
				<div class="tab-pane fade in active" id="sensitivity">
					...
					<fieldset>
					 <div class="form-row control-group row-fluid ">
                  <label class="control-label span3">Perform sensitivity profile test </label>
                  <div class="controls span9">
                    <label class="checkbox inline">
                      <input type="checkbox"  value="sensitivity" name="sensitivity" id="sensitivity">
                      </label>
