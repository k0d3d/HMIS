        ...
        <div class="span3">
          ...
          <div class="content">
            ...
            <ul class="nav nav-tabs dark nav-stacked">
              ...
              <li><a href="docview.php?patient=<?php echo $_GET["patient"]; ?>"><i class="gicon-wrench"></i> Attend to</a></li>

   
              <li><a href="doctor.php"><i class="gicon-lock"></i> Exit patient card</a></li>
            </ul>
			<?php } ?>
          </div>
          <!-- End .content --> 
...
<p>Last temperature taken: <?php echo "$patientvtemp"; ?> &deg;</p>
			...
			<p>Last Blood pressure: <?php echo "$patientvblood"; ?> mmHg</p>
