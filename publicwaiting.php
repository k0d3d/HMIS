...
$getwaitinglist = mysql_query("select * from waiting order by id ASC") or die(mysql_error());
...
<div id="main">
  <div class="container">
    <div class="header row-fluid">
      <div class="logo"> <a href="index.html"><span>NEW IKEJA HOSPITAL</span></a> </div>
      <div class="top_right">
        <ul class="nav nav_menu">
          <li class="dropdown"> <a class="dropdown-toggle administrator" id="dLabel" role="button" data-toggle="dropdown" data-target="#" href="/page.html">
            <div class="title"><span class="name"><?php echo date('d M Y'); ?></span></div>
            ...
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              <thead>
                <tr>
                  ...
                  <th class="to_hide_phone ue no_sort">Reason</th>
                  <th class="">Timer</th>
                  <th class="">Status</th>
...
?>
                ...
                <tr>
                  ...
                  <td class="to_hide_phone"><a href = "case.php?patient=<?php echo "$pid1"; ?>&reason=<?php echo "$reason"; ?>&activate&timer=<?php echo "$time1"; ?>"><?php echo "$username"; ?> <?php echo "$othername"; ?></a></td>
                  <td class="to_hide_phone"><div class="row-fluid"><small>
                      <div class="span12"><strong><?php echo "$reason"; ?></strong></div>
                      </small></div>
                    </td>
