...
$getlabwaitinglist = mysql_query("select * from doclabwaiting order by id DESC") or die(mysql_error());
...
echo "<h1><font color = \"green\">$msg</font></h1>";}
      ...
      <div class="row-fluid">
        <div class="box ">
          <div class="title">
            <h4> <span>patient Waiting list</span> </h4>
          </div>
          <!-- End .title -->
...
<?php echo "$time1"; ?>
		 ...
		 <div class="box ">
          <div class="title">
            <h4> <span>Laboratory test results</span> </h4>
          </div>
          <!-- End .title -->
            ...
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              <thead>
                <tr>
                  ...
                  <th class="jv no_sort">Image</th>
                  <th class="to_hide_phone  no_sort">Name</th>
                  <th class="to_hide_phone  no_sort">Lab Scientist</th>
			  ...
			  <tbody>
			  <?php while ($frow1 = mysql_fetch_array($getlabwaitinglist)) {?>
				<?php
				$rid1 = $frow1['id'];
				$pid1 = $frow1['patientid'];
				$labid = $frow1['labid'];
...
$cstaff = mysql_query("SELECT * FROM `user` WHERE `id`='".$labid."'");
$staff_row=mysql_fetch_array($cstaff);
$nursename = $staff_row['staffname'];
?>
                ...
                <tr>
                  ...
                  <td><img class="thumbnail small" src="img/message_avatar4.png"></td>
                  <td class="to_hide_phone"><a href = "labresults.php?id=<?php echo "$rid1"; ?>&patient=<?php echo "$pid1"; ?>&activate&timer=<?php echo "$time1"; ?>&nursename=<?php echo "$nursename"; ?>&name=<?php echo "$username"; ?> <?php echo "$othername"; ?>"><?php echo "$username"; ?> <?php echo "$othername"; ?></a></td>
                  <td class="to_hide_phone"><?php echo "$nursename"; ?></a></td>
